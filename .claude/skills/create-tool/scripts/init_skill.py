...
def init_skill(skill_name: str, output_path: str, github_username: str) -> None:
    ...
    directories = [
        ...
        os.path.join(skill_dir, '.claude', 'commands'),
    ]
    ...
    # deploy.md 커맨드 생성
    deploy_path = os.path.join(skill_dir, '.claude', 'commands', 'deploy.md')
    with open(deploy_path, 'w', encoding='utf-8') as f:
        f.write(create_deploy_command())
    print(f"✓ 파일 생성: {deploy_path}")
